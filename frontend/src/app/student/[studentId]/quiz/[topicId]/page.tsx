...
export default async function QuizPage({
  ...
  // point (e.g. a ProgressTrail topic card) keeps the adaptive QuizRunner —
  // both now render their own question-navigator sidebar + Learning Tools
  // panel internally, so this page no longer needs a second column itself.
